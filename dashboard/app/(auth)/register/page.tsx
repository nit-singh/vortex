  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await authApi.signup({
        ...
        userType: "consumer", // Default to consumer for now
      });

      if (response.success) {
        // Don't set isAuthenticated - user needs to login first
      ...
      <div className="w-full max-w-[380px]">
        ...
        <div className="text-center mb-[32px]">
          ...
          <p className="text-[14px] text-[#999999]">
            Sign up to get started with Pathway
          </p>
        </div>
        ...
        <div className="bg-[#1a1a1a] rounded-[16px] p-[32px] border border-[#2a2a2a] relative">
          <form onSubmit={handleSubmit} className="space-y-[20px]">
            ...
            <div className="relative">
              <User className="absolute left-[16px] top-1/2 -translate-y-1/2 h-[18px] w-[18px] text-[#666666]" />
              <Input
                type="text"
            ...
            >
              ...
              <span className="ml-[8px]">Sign up with Google</span>
            </Button>
